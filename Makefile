...
GOPHER 		= ~/Documents/software/Atari\ 2600/Gopher2600/gopher2600_darwin_arm64
...
ifeq ($(EMULATOR), gopher)
	tmux new-session -d -s $(EMULATOR) $(GOPHER) -tv NTSC -right savekey $(OUTPUT)/$(CUSTOMNAME).bin
endif
...
.PHONY: arm
arm: $(CUSTOMOBJS) $(OBJS) $(CUSTOMTARGETS)
