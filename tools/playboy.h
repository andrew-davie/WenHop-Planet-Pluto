 ...
 * playboy_screen_frames, a table of 3 pointers in cycle order. Index it
...
/* e.g. playboy_screen_frames[frame_counter % SCREEN_NUM_FRAMES] */
extern const ScanLine * const playboy_screen_frames[SCREEN_NUM_FRAMES];
