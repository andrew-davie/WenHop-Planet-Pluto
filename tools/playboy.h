...
/* 2-frame vertically-blended scanline data.
 ...
 *
 * 2 full screens are supplied (screen_frame0, screen_frame1). Cycle through them
 * one per video frame, in order, then wrap back to frame 0 and repeat
 * forever (frame0, frame1, frame0, ...).
 ...
 * behind, so that the 1/2-weighted temporal average the eye
