 ...
 * pirate_screen_frames, a table of 3 pointers in cycle order. Index it
 * by a running frame counter (mod PIRATE_NUM_FRAMES): cycle frame 0, 1,
...
#define PIRATE_PARAMS "image=pirate.webp width=48 height=128 sigma=1.0 radius=5 rounds=10 sweeps=3 metric=luma seeds=6 smoothness=1.2 swaps=False saturation=1.5 brightness=1.5 frames=3 temporal_weight=0.0 frame_scheme=cumulative frame_mode=cyclic outer_rounds=12 roll_scanlines=False roll_band_height=None"

/* e.g. pirate_screen_frames[frame_counter % PIRATE_NUM_FRAMES] */
extern const ScanLine * const pirate_screen_frames[PIRATE_NUM_FRAMES];
