 ...
 * by a running frame counter (mod ZPH_NUM_FRAMES) exactly as usual --
...
#define ZPH_PARAMS "image=zph.png width=48 height=128 sigma=1.0 radius=5 rounds=8 sweeps=3 metric=luma seeds=6 smoothness=0.5 saturation=1.0 brightness=1.0 frames=3 outer_rounds=8 temporal_weight=0.0 roll_scanlines=True roll_band_height=40 frame_scheme=cumulative"
