 ...
 * obama_screen_frames, a table of 3 pointers in cycle order. Index it
...
#define OBAMA_PARAMS "image=obama.jpg width=48 height=128 sigma=1.0 radius=1 rounds=8 sweeps=3 metric=luma seeds=3 smoothness=0.5 saturation=1.0 brightness=1.2 frames=3 outer_rounds=5 temporal_weight=1.0 roll_scanlines=True roll_band_height=16"

/* e.g. obama_screen_frames[frame_counter % SCREEN_NUM_FRAMES] */
extern const ScanLine * const obama_screen_frames[SCREEN_NUM_FRAMES];
