 ...
 * by a running frame counter (mod TOYSTORY_NUM_FRAMES): cycle frame 0, 1,
...
#define TOYSTORY_PARAMS "image=toystory.jpg width=48 height=128 sigma=1.0 radius=5 rounds=8 sweeps=3 metric=luma seeds=6 smoothness=0.5 saturation=1.0 brightness=1.0 frames=3 outer_rounds=8 temporal_weight=0.0 roll_scanlines=False roll_band_height=None frame_scheme=cumulative"

/* e.g. toystory_screen_frames[frame_counter % TOYSTORY_NUM_FRAMES] */
extern const ScanLine * const toystory_screen_frames[TOYSTORY_NUM_FRAMES];
