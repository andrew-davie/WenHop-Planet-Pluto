...
const unsigned char *const charSet[] = {
    ...
    CH2(CHAR_MAP_0to9_0_1),    // 149 CH_0
    CH2(CHAR_MAP_0to9_1_1),    // 150 CH_1
    CH2(CHAR_MAP_0to9_2_1),    // 151 CH_2
    CH2(CHAR_MAP_0to9_3_1),    // 152 CH_3
    CH2(CHAR_MAP_0to9_4_1),    // 153 CH_4
    CH2(CHAR_MAP_0to9_5_1),    // 154 CH_5
    CH2(CHAR_MAP_0to9_6_1),    // 155 CH_6
    CH2(CHAR_MAP_0to9_7_1),    // 156 CH_7
    CH2(CHAR_MAP_0to9_8_1),    // 157 CH_8
    CH2(CHAR_MAP_0to9_9_1),    // 158 CH_9

    CH2(CHAR_MAP_0to9_0_3),    // 159 CH_A
    CH2(CHAR_MAP_0to9_1_3),    // 160 CH_B
    CH2(CHAR_MAP_0to9_2_3),    // 161 CH_C
    CH2(CHAR_MAP_0to9_3_3),    // 162 CH_D
    CH2(CHAR_MAP_0to9_4_3),    // 163 CH_E
    CH2(CHAR_MAP_0to9_5_3),    // 164 CH_F
    CH2(CHAR_MAP_0to9_6_3),    // 165 CH_G
    CH2(CHAR_MAP_0to9_7_3),    // 166 CH_H
    CH2(CHAR_MAP_0to9_8_3),    // 167 CH_I
    CH2(CHAR_MAP_0to9_9_3),    // 168 CH_J
    CH2(CHAR_MAP_0to9_0_4),    // 169 CH_K
    CH2(CHAR_MAP_0to9_1_4),    // 170 CH_L
    CH2(CHAR_MAP_0to9_2_4),    // 171 CH_M
    CH2(CHAR_MAP_0to9_3_4),    // 172 CH_N
    CH2(CHAR_MAP_0to9_4_4),    // 173 CH_O
    CH2(CHAR_MAP_0to9_5_4),    // 174 CH_P
    CH2(CHAR_MAP_0to9_6_4),    // 175 CH_Q
    CH2(CHAR_MAP_0to9_7_4),    // 176 CH_R
    CH2(CHAR_MAP_0to9_8_4),    // 177 CH_S
    CH2(CHAR_MAP_0to9_9_4),    // 178 CH_T
    CH2(CHAR_MAP_0to9_0_5),    // 179 CH_U
    CH2(CHAR_MAP_0to9_1_5),    // 180 CH_V
    CH2(CHAR_MAP_0to9_2_5),    // 181 CH_W
    CH2(CHAR_MAP_0to9_3_5),    // 182 CH_X
    CH2(CHAR_MAP_0to9_4_5),    // 183 CH_Y
    CH2(CHAR_MAP_0to9_5_5),    // 184 CH_Z

    CH2(CHAR_MAP_0to9_0_7),    // 185 CH_A
    CH2(CHAR_MAP_0to9_1_7),    // 186 CH_B
    CH2(CHAR_MAP_0to9_2_7),    // 187 CH_C
    CH2(CHAR_MAP_0to9_3_7),    // 188 CH_D
    CH2(CHAR_MAP_0to9_4_7),    // 189 CH_E
    CH2(CHAR_MAP_0to9_5_7),    // 190 CH_F
    CH2(CHAR_MAP_0to9_6_7),    // 191 CH_G
    CH2(CHAR_MAP_0to9_7_7),    // 192 CH_H
    CH2(CHAR_MAP_0to9_8_7),    // 193 CH_I
    CH2(CHAR_MAP_0to9_9_7),    // 194 CH_J
    CH2(CHAR_MAP_0to9_0_8),    // 195 CH_K
    CH2(CHAR_MAP_0to9_1_8),    // 196 CH_L
    CH2(CHAR_MAP_0to9_2_8),    // 197 CH_M
    CH2(CHAR_MAP_0to9_3_8),    // 198 CH_N
    CH2(CHAR_MAP_0to9_4_8),    // 199 CH_O
    CH2(CHAR_MAP_0to9_5_8),    // 200 CH_P
    CH2(CHAR_MAP_0to9_6_8),    // 201 CH_Q
    CH2(CHAR_MAP_0to9_7_8),    // 202 CH_R
    CH2(CHAR_MAP_0to9_8_8),    // 203 CH_S
    CH2(CHAR_MAP_0to9_9_8),    // 204 CH_T
    CH2(CHAR_MAP_0to9_0_9),    // 205 CH_U
    CH2(CHAR_MAP_0to9_1_9),    // 206 CH_V
    CH2(CHAR_MAP_0to9_2_9),    // 207 CH_W
    CH2(CHAR_MAP_0to9_3_9),    // 208 CH_X
    CH2(CHAR_MAP_0to9_4_9),    // 209 CH_Y
    CH2(CHAR_MAP_0to9_5_9),    // 210 CH_Z

    CH2(CHAR_MAP_0to9_0_2),    // 211 CH_PLUS

    CH2(CHAR_MAP_0to9_0_0),    // 212 CH_BIG_0
    CH2(CHAR_MAP_0to9_1_0),    // 213 CH_BIG_1
    CH2(CHAR_MAP_0to9_2_0),    // 214 CH_BIG_2
    CH2(CHAR_MAP_0to9_3_0),    // 215 CH_BIG_3
    CH2(CHAR_MAP_0to9_4_0),    // 216 CH_BIG_4
    CH2(CHAR_MAP_0to9_5_0),    // 217 CH_BIG_5
    CH2(CHAR_MAP_0to9_6_0),    // 218 CH_BIG_6
    CH2(CHAR_MAP_0to9_7_0),    // 219 CH_BIG_7
    CH2(CHAR_MAP_0to9_8_0),    // 220 CH_BIG_8
    CH2(CHAR_MAP_0to9_9_0),    // 221 CH_BIG_9

    CH(CHAR_MAP_characterset_1_15),    // 222 CH_TELEPORT_1
    CH(CHAR_MAP_characterset_2_15),    // 223 CH_TELEPORT_2
    CH(CHAR_MAP_characterset_3_15),    // 224 CH_TELEPORT_3
    CH(CHAR_MAP_characterset_4_15),    // 225 CH_TELEPORT_4
    CH(CHAR_MAP_characterset_5_15),    // 226 CH_TELEPORT_5
    CH(CHAR_MAP_characterset_6_15),    // 227 CH_TELEPORT_6
    CH(CHAR_MAP_characterset_7_15),    // 228 CH_TELEPORT_7

    CH(CHAR_MAP_characterset_0_17),    // 229 CH_DOORSLIDE_1
};
