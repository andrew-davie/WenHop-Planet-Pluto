...
// GS_RASTER_BLEED disabled (see gameState_RasterBleed.c) -- body commented out so this is a
// no-op even though it's still called (also commented out) from the disabled VB_RasterBleed().
