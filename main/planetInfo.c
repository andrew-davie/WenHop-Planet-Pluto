...
/* 4 */ {"=\"There is|no word for|stranger, and|I was given a|family on|arrival.}They had|views on how|I spent my|days.#",2}, // 8
...
{"=\"A local|ritual. Six|hours. Nothing|happened.|The locals|were very|pleased. I|asked.}They said|%fine&.#",2}, // 8
// {"=\"The|smell here is|called|%distinctive&|in the|brochure.|Calling a fire|warm is also|not|wrong.#",1}, // 8
{"=\"The|locals have|perfect|recall. I had|forgotten|what I said|on day one.|They had|not. Day|three was|hard.#",1}, // 9
...
{"=\"I asked|about the|length of the|tour. The|guide said it|depended on|interest.}She said I|seemed very|keen.#",2}, // 7
...
{"=\"The|shadow|followed me|the whole|time. When I|complained,|I was told it|was mine.}This only|raised more|issues.#",2}, // 8
// Planet 6
{"=\"A human|told me to|have a nice|day, and I|said I would|try. It looked|at me as|though trying|was not the|expected|reply.#",3}, // 5 — "A human"/"It" pronoun mismatch
...
{"=\"The|wildlife|ignored me|until it did|not.}The|transition was|not|marked.#",1}, // 9
...
{"=\"The|local dish|arrived alive|and looking at|me.}I did not|know the|correct|reply.#",1}, // 8
{"=\"The|ocean laps|the shore in a|way that|sounds like it|is sighing ~at|you.#",1}, // 7
...
{"=\"The|signs use a|language I do|not read.|The locals|also do not|read it.~}This was not|noted.#",2}, // 8
